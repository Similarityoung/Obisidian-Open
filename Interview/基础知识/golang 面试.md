...
- [[Interview/基础知识/golang 面试 - 语言基础]]
  主题：slice、map。
- [[Interview/基础知识/golang 面试 - 并发编程与同步控制]]
  主题：channel、context、sync、并发模型设计。
- [[Interview/基础知识/golang 面试 - 运行时 (Runtime)]]
  主题：GMP、调度器、GC、运行时机制。

## 使用建议

- 先看 [[Interview/基础知识/golang 面试 - 语言基础]]，再看 [[Interview/基础知识/golang 面试 - 并发编程与同步控制]]。
- 第三篇建议看 [[Interview/基础知识/golang 面试 - 运行时 (Runtime)]]，把 GMP、调度器和运行时细节补齐。
